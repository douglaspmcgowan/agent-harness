...
- This repository has documentation and scripts rather than a product interface.
- The HTML human guide mirrors the Markdown guide and must remain readable on desktop and phone widths.
