...
process.stdin.on('end', () => {
  try {
    ...
    // Only act on Agent tool completions that look like Codex dispatches
    ...
    const reminderPath = path.join(process.env.USERPROFILE || process.env.HOME || '', '.claude', 'BACKGROUND-TASKS.md');
