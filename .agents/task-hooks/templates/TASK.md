...
<!-- Record each direct or embedded question as a checkbox task with completion evidence. -->
...
Do not create an Answers section; answers belong in chat or durable topic documentation.
