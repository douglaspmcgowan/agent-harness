...
> **36 themes**, **11 full-deck templates**, **31 page layouts**,
...
> One command installs **36 themes × 20 canvas FX × 31 layouts × 11 full decks**. Every preview above is a live iframe of a real template file rendering inside the deck — no screenshots, no mock-ups.
...
> "Make an 8-page tech talk deck, using the cyberpunk theme"
> "turn this outline into a pitch deck"
> "render and check every slide of my deck"
...
| 📑 **Full-deck templates** | **12** | `templates/full-decks/<name>/` |
...
![11 full-deck templates](docs/readme/templates.png)

### 12 Full-deck templates

Six extracted from real-world decks, six generic scenario scaffolds:
...
open templates/full-decks-index.html       # all 11 full decks
...
│   ├── full-decks.md             11 full-deck templates
...
│   ├── full-decks-index.html     12-deck gallery
│   ├── full-decks/<name>/        12 scoped multi-slide decks
