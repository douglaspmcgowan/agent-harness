...
it look good", "你帮我选", "随便", or hands you content with no style cue. If the
...
| **小红书 (xiaohongshu)** | `xiaohongshu-white` · `soft-pastel` | `capsule` · `magazine-bold` · `playful` | `pink-script` |
...
- A full-deck template is the obvious fit (e.g. "产品发布会" → `product-launch`)
